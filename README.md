# `SmartCapture` Sample app

Here you can find an implementation example for the demos for the `Face` and `Document` modules. You can find SDK documentation [here](https://smartcapture-docs.idscan.cloud/docs/ios/intro)
...
1. Add the following XCFrameworks to `/Dependencies` [directory](./Dependencies/) and your project:
  - `Dependencies/document/Document.xcframework`
  - `Dependencies/document/IDSCamera.xcframework`
...
4. Customise the localised messages following the keys provided in the documentation:
    - Face: https://smartcapture-docs.idscan.cloud/docs/ios/face-camera/customization
    - Document: https://smartcapture-docs.idscan.cloud/docs/ios/document/customization

5. Import a module where needed:
    ```swift
    import FaceCamera
    ```
    or 
